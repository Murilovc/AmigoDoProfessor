...
import com.mvc.amigodoprof.model.cellrenderer.CellRendererParaAtividades;
import com.mvc.amigodoprof.model.cellrenderer.HeaderRendererDoProf;

public class ColumnModelParaAtividade extends DefaultTableColumnModel{
    
	public ColumnModelParaAtividade(Alinhamento[] alinhamento, int quantidadeColunas,
    ...
    private TableColumn criaColuna(Alinhamento alinhamento, int indiceColuna,
    	...
    	CellRendererParaAtividades acr = new CellRendererParaAtividades(tamanhoFonte, corCelulas, alinhamento);
