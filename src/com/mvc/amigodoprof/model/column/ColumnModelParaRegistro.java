...
import com.mvc.amigodoprof.model.cellrenderer.CellRendererParaRegistro;
import com.mvc.amigodoprof.model.cellrenderer.HeaderRendererDoProf;

public class ColumnModelParaRegistro extends DefaultTableColumnModel{
	
	public ColumnModelParaRegistro(Alinhamento[] alinhamento, int quantidadeColunas,
    	...
    	for(int i = 0; i < quantidadeColunas; i++) {
    		...
    		switch(i) {
        		case 0:
        			tc.setPreferredWidth((int) (pontoLargura*65f));
        			break;
        		case 1:
        			tc.setPreferredWidth((int) (pontoLargura*12.42f));
        			break;
        		case 2:
        			tc.setPreferredWidth((int) (pontoLargura*22.58f));
        			break;
            }
    ...
    private TableColumn criaColuna(Alinhamento alinhamento, int indiceColuna,
    	...
    	CellRendererParaRegistro acr = new CellRendererParaRegistro(tamanhoFonte, corCelulas, alinhamento);
